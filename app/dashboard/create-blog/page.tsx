...
export default function CreateBlogRoute() {
  ...
  return (
    <div>
      <Card>
        ...
        <CardContent>
          <form className="flex flex-col gap-4" action={handleBlogSubmission}>
            ...
            <Button type="submit" className="cursor-pointer" disabled={!imageUrl || uploading}>
              Create Post
            </Button>
          </form>
        </CardContent>
      ...
      <details className="text-sm mt-2 mr-6 border border-gray-300 dark:border-gray-600 rounded-md p-4 shadow-sm w-full ">
        <summary className="cursor-pointer font-semibold text-base">📚 LaTeX Quick Guide</summary>
      ...
      <Button
        variant="outline"
        className="h-9 mt-2 w-25 cursor-pointer"
      ...
      {showContentPreview && (
        <div>
          <h2 className="font-semibold text-lg text-gray-800 dark:text-white mb-2 mt-1"> Content Preview:</h2>
